...
EDA - distribution of movie runtimes (aesthetics tbc)
```{r}
...
Is this an EDA? - relationship between list appearances and likes (aesthetics tbc)
```{r}
...
Is this an EDA? - relationship between runtime and average rating (aesthetics tbc)
```{r}
