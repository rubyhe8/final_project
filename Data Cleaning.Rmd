...
EDA - genre df cleaning and genre count
```{r}
genre_df = movie_df |>
...
genre_wide = genre_df |> 
  mutate(studios = map_chr(studios, ~ paste(.x, collapse = ", ")),
    description = as.character(description),
    genres = map_chr(genres, ~ paste(.x, collapse = ","))
  ) |> 
...
Linear Regression Model to further analyze the relationship (run time as categorical variable )
```{r}
