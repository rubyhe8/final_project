...
Run time (continuous)
Total times watched (count)
Genre (categorical) top 5 genres only
Number of watches 
List appearances 
Fans
Likes 
...
model_movie_df = read.csv("data/letterbox_movie_classification_dataset.csv") |>
  ...
  select(average_rating, genres, runtime, watches, list_appearances, likes, fans, lowest, medium, highest, total_ratings)
```
...
* also seen in the plot of resid vs. pred - the smooth model is not evenly distributed across resid = 0

Our final model is a generalized additive model with the following predictors 
