...
Based on the models above, the model with runtime adjusted for covariates is the best to predict a movie's average rating due to having the lowest RMSE, followed by appearances. Runtime individually is the weakest predictor.