...
movie_df |> 
  ...
  labs(
    x = "Appearances",
    y = "Average Rating",
    title = "Linear Relationship Betweem Appearances on User-Curated Lists and Average Rating"
  )
...
movie_df |> 
  ...
  labs(
    ...
    y = "Average Rating",
    title = "Linear Relationship Between Number of Fans (Log Scale) and Average Rating"
  )
...
Based on the models above, the model with runtime adjusted for covariates is the best model to predict a movie's average rating due to having the lowest RMSE, followed by appearances. Runtime individually is the weakest predictor.