...
```
Dichotomizing the variables to greater and less than 100 mins made the model more accurate and better to visualize. Runtime seems to be a hard variable to work with in general given the amount of possible outcomes and different run times. Though when put in the overall model it works well as a predictor and the longer the moive the higher the rating for movies over 90 mins but the longer the movie the lower the rating for movies under 90 mins. This is a interesting comparision to big more into. 
